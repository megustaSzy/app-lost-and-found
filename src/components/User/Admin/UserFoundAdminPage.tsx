...
export default function UserFoundAdminPage() {
  const { data, error, isValidating } = useSWR("/found/foundreports/admin", fetcher);
    ...
    <Card>
      ...
      <CardContent className="relative">
        {(isLoading || isValidating) && (
          <LoadingOverlay label={isLoading ? "Memuat..." : "Memperbarui..."} />
        )}
      ...
      <AdminFoundDetailModal report={selectedReport} onClose={() => setSelectedReport(null)} />
    </Card>
  );
}
